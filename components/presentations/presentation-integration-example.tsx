...
import { RealtimePresentation } from './realtime-presentation'
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`p-2 rounded ${
                  showDebugInfo ? 'bg-blue-100 text-blue-800' : 'bg-muted text-muted-foreground'
                }`}
            ...
            {participants.map((participant, index) => (
              ...
              >
                ...
                <div className={`px-2 py-1 rounded text-xs ${
                  participant.user_role === 'presenter' 
