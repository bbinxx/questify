        ...
        <div className={`h-screen flex flex-col overflow-hidden ${darkMode ? 'dark' : ''}`}>
            ...
            <header className="h-14 flex-shrink-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-3 gap-2">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <button className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-300 hidden md:flex">
                        <SettingsIcon />
                    </button>
                    <button className="btn-outline hidden lg:flex text-xs px-3 py-1.5">
                        Upgrade
                    </button>
                    ...
                    <button className="btn-accent flex items-center gap-1.5 text-xs px-3 py-1.5">
                        <SaveIcon />
            ...
            <div className="flex-1 flex overflow-hidden bg-slate-100 dark:bg-slate-950">
                ...
                `}>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-medium text-primary-600 dark:text-primary-400">1/1</span>
                    </div>

                    <div className="flex-1 overflow-y-auto space-y-2 min-h-0">
                        <div className="relative p-2.5 rounded-lg border-2 border-primary-500 bg-primary-50 dark:bg-primary-950/50 cursor-pointer">
                            <span className="absolute -top-1.5 -left-1.5 w-5 h-5 rounded-full bg-primary-600 text-white text-[10px] font-bold flex items-center justify-center">
                                1
                            </span>
                            <div className="h-10 rounded bg-primary-600 dark:bg-primary-700 flex items-center justify-center">
                                <QuestionIcon />
                            </div>
                            <p className="mt-1.5 text-[10px] font-medium text-slate-600 dark:text-slate-300 text-center">Quiz</p>
                        </div>
                    </div>
                ...
                <main className="flex-1 flex flex-col overflow-hidden p-2 sm:p-3 lg:p-4">
                    <div className="flex-1 flex flex-col overflow-hidden max-w-4xl mx-auto w-full">
                        <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800">
                                ...
                                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                                    {answers.map((answer, index) => (
                                        ...
                                        >
                                            ...
                                            <button className="hidden sm:block p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors">
                                                <ImageIcon />
                                            </button>
                                        </div>
                                    ))}
                            ...
                            {/* Add More Button */}
                            <button className="flex-shrink-0 mx-2 sm:mx-3 mb-2 sm:mb-3 py-2 rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-600 text-slate-500 dark:text-slate-400 text-xs font-medium hover:border-primary-400 hover:text-primary-500 transition-colors flex items-center justify-center gap-1">
                                <PlusIcon /> Add more
                            </button>
                        </div>
                    </div>
                ...
                `}>
                    ...
                    <div className="flex-1 overflow-y-auto space-y-3 min-h-0">
                        <div className="space-y-1.5">
                            ...
                            <select className="select text-xs py-2" value={answerType} onChange={(e) => setAnswerType(e.target.value)}>
                                <option>Quiz</option>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <select className="select text-xs py-2" value={timeLimit} onChange={(e) => setTimeLimit(e.target.value)}>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <select className="select text-xs py-2" value={points} onChange={(e) => setPoints(e.target.value)}>
